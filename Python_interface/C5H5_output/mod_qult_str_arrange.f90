...
integer, allocatable::str3(:,:), sym_str_sl(:,:), sym_str_sl_final(:,:), pref_radical1(:), pref_radical2(:)
...
integer, allocatable::sym_str_num_final(:), sym_str_qual(:), sym_str_qual1(:,:), mbondq1(:), mbondq2(:)
...
allocate(str3(x,y))
allocate(mbondq1(x))
allocate(pref_radical1(x))
allocate(mbondq2(x))
allocate(pref_radical2(x))
...
jj=1
loop1:do m19=1,n
  write(*,231)'str2:qarng',m19,(str2(m19,m18),m18=1,nae),quality_fac(m19),symq(m19)
  ...
  do m18=1,nqul1
    do m19=1,n
      if(quality_fac(m19).eq.qual4(m18))then 
        ...
        bdq(i4)=bondq(m19)
        mbondq1(i4)=mbondq(m19)
        pref_radical1(i4)=pref_radical(m19)
      endif
    enddo
  enddo
endif
...
101  l=0
 ...
 ! 906 format (50I3)
  ...
  !q_fac1(i9)=q_fac(sym_str_sl_final(i1,i2))
      ...
      mbondq1(i9)=mbondq(sym_str_sl_final(i1,i2))
      pref_radical1(i9)=pref_radical(sym_str_sl_final(i1,i2))
    enddo
  enddo
...
do i=1,n
  ...
  bondq(i)=bdq(i)
  mbondq(i)=mbondq1(i)
  pref_radical(i)=pref_radical1(i)
enddo
...
!enddo
  do j=1,n
    loop9:do i=1,l
      ...
      bdq(j1)=bondq(j)
      mbondq1(j1)=mbondq(j)
      pref_radical1(j1)=pref_radical(j)
    enddo loop9
  enddo
...
do i3=1,nstrt
print*,'strt_struc',(strt_struc(i3,i),i=1,nae)
enddo
...
340 jj=0
    do i=1,kk
      ...
      mbondq2(jj)=mbondq1(st_ct1(i))
      pref_radical2(jj)=pref_radical1(st_ct1(i))
    enddo                      
    ...
    loop13:do i=1,n
      ...
      stq4(jj)=stq2(i)
      bdq1(jj)=bdq(i)
      mbondq2(jj)=mbondq1(i)
      pref_radical2(jj)=pref_radical1(i)
    enddo loop13
    ...
    do i=1,n
      ...
      bondq(i)=bdq1(i)
      mbondq(i)=mbondq2(i)
      pref_radical(i)=pref_radical2(i)
      do i2=1,nae
        str1(i,i2)=str3(i,i2)
      enddo
    enddo
...
do m18=1,n
write(*,231),'str:quality_arrange',m18,(str1(m18,m19),m19=1,nae),q_fac1(m18),bondq(m18),quality_fac(m18) !&
