...
implicit none
contains
subroutine qult_str_arrange(nl,str2,n,quality_fac,str1,q_fac1)
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!common/quality/str_quality_1,str_quality_2,bondq,tqlty,bqlty,sqlty,tnqs,nssym,qulsym,symq,&
!sigsym,tnqs_sig

integer::i1,l,k,m,bnd,ll
integer::p,nstrt1,mq_fac,msymq,mloopsymsc,ind,sl,sll
integer::i,i2,i3,i4,i9,m18,m19,k6,k7,k8,k9,ii,kk
integer::n,jj,j,j1,nqul1,nl,iii,x,y
!integer::str_quality_1(15000),str_quality_2(15000),bondq(15000),sigsym(15000),tnqs_sig&
!,tqlty,bqlty,sqlty,tnqs,nssym,qulsym(15000),symq(15000)
integer::lll,nssym1,mm
...
integer,dimension(:),allocatable::stq1, stq2, stq3, stq4, sl_num, sl_qfac, sl_qfac1, str_cnt1
integer, allocatable::st_ct(:), st_ct1(:), sym_str_sl(:,:), sym_str_sl_final(:,:), sym_str_num(:)
integer, allocatable::sym_str_num_final(:), sym_str_qual(:), sym_str_qual1(:,:), quality_fac(:)
integer, pointer::str1(:,:),str2(:,:),q_fac1(:)
