...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
module mod_eq_dstr_set
use commondat_mod
use mod_eq_dst_check
implicit none
...
integer::tns,lnp,npstr,fail,num_str,numpstr
integer, allocatable::strsln(:)
