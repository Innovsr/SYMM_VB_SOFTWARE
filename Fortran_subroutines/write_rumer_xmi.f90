...
integer::i,i7,nstr,m19,m20,nl,rumer(15000),rumer_rad(15000),allrum
!integer::str_quality_1(15000),bondq(15000),str_quality_2(15000),tqlty,bqlty,sqlty,tnqs
!integer::sigsym(15000),tnqs_sig,nssym,qulsym(15000),symq(15000)
integer::col(1000),rumstr(500,20)
real*8::ovlp
