...
nd,k3,k4,k5,n,nssym,j,jj,ii2,nnat_bond_new_1(100,2)
integer::nnat_bond_new(100,2),nn_count(50),sig_orb(100),sig_orb_1(100),nsig,nnatom&
,nn4,nn5,nna
real*8::tscore,score(100,2),new_score(100,2),ssym(15000),order(15000),lpna,&
losc,lone_score(15000),sig_sym_sc(15000),n7,n8
...
integer::symq(15000),connectivity_row(20,20)
!integer::kval(1000),deadend(20)
!integer::atsymset(20,20),nsym,syn(50),at_sym(50),
integer::numbond,numbond1,loop_score_row(20),coordination_mat(20,20)
