...
contains
subroutine nnat_bond_sig(n,sig_orb,nsig,j)
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
if (.not. allocated(nnat_bond_new_1))then
allocate(nnat_bond_new_1(n*2, 2))
nnat_bond_new_1 = 0
endif
